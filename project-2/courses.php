            ...
            <div data-simplebar class="h-100">
                ...
                <div class="user-sidebar text-center">
                    <div class="dropdown">
                        ...
                        <div class="user-info">
                            <h5 class="mt-3 font-size-16 text-white">Ali Imran</h5>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="../resources/views/admin/auth/auth-login.blade.php">Login</a></li>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- <h4 class="header-title mb-4 float-sm-start">Course Management</h4> -->
                                        ...
                                        <!-- Todo:page content -->
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            ...
                                                            <img src="assets/images/courses/python.png" alt="python" class="img-fluid mx-auto d-block" />
                                                        </div>
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <h4 class="mt-3 mb-0">
                                                                $200
                                                                <span class="font-size-14 text-muted me-2"><del>$240</del></span>
                                                            </h4>
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            <img src="assets/images/courses/js.png" alt="js" class="img-fluid mx-auto d-block" />
                                                        </div>
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            <!-- <div class="product-ribbon bg-primary">25% Off</div> -->

                                                            <img src="assets/images/courses/c-sharp.png" alt=csharp"" class="img-fluid mx-auto d-block" />
                                                        </div>
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <h4 class="mt-3 mb-0">
                                                                $380
                                                                <span class="font-size-14 text-muted me-2"><del>$420</del></span>
                                                            </h4>
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            <img src="assets/images/courses/dart.png" alt="dart" class="img-fluid mx-auto d-block" />
                                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            ...
                                                            <img src="assets/images/courses/java.png" alt="java" class="img-fluid mx-auto d-block" />
                                                        </div>
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <h4 class="mt-3 mb-0">
                                                                $280
                                                                <span class="font-size-14 text-muted me-2"><del>$320</del></span>
                                                            </h4>
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            <img src="assets/images/courses/php.png" alt="php" class="img-fluid mx-auto d-block" />
                                                        </div>
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            <img src="assets/images/courses/ruby.png" alt="ruby" class="img-fluid mx-auto d-block" />
                                                        </div>
                                            ...
                                            <div class="col-xl-3 col-sm-6">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="product-img">
                                                            <img src="assets/images/courses/swift.png" alt="swift" class="img-fluid mx-auto d-block" />
                                                        </div>
