...
<body>
    ...
    if ($todoDeleted) {
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Success!!</strong> Your TODO item has been deleted successfully
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>';
    }
            ...
            if ($number_of_rows > 0) {
                ...
                while ($entry = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<tr>
                            ...
                            <td>
                                <span class="d-flex" >
                                    <a class="btn btn-sm btn-outline-warning mx-1" href="show.php?id=' . $entry['id'] . '">
                                    ...
                                    <form action="backend/delete.php" method="POST" class="mx-1">
                                        <input type="hidden" value="' . $entry['id'] . '" name="todo_id">
                ...
                echo "<center><h1>No Todo found</h1></center>";
            }
